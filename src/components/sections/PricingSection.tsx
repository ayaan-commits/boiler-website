...
const pricingTiers = [
  ...
  {
    name: "Full Combi Installation",
    description: "New position or first-time install",
    price: "From \u00A32,200",
    popular: true,
    includes: [
  ...
  },
  {
    ...
    description: "For larger homes or existing cylinder setups",
    price: "From \u00A32,500",
    includes: [
      "Everything in Full Combi Installation",
